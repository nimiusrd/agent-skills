...
プロパティベーステストの生成、リファクタリング、Pull Request の作成・再レビューなど、日常的な開発作業に使えるスキルを収録しています。
...
| [public-repository-setup](skills/public-repository-setup/SKILL.md) | 公開リポジトリの新規作成時に、ルールセット・リリース・Issue／PRの初期設定を行う | 「公開リポジトリを作って初期設定して」 |
